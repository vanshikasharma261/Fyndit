    ...
    <article className={styles.card}>
      ...
      <div className={styles.meta}>
        <div className={styles.metaCol}>
          <span className={styles.metaLabel}>{AddressMessages.cityLabel}</span>
          <span className={styles.metaValue}>{address.city}</span>
        </div>
        <div className={styles.metaCol}>
          <span className={styles.metaLabel}>{AddressMessages.stateLabel}</span>
          <span className={styles.metaValue}>{address.state}</span>
        </div>
        <span className={styles.zipChip}>
          {AddressMessages.zipLabel}: {address.zip}
        </span>
      </div>
